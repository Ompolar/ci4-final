...
<div class="content-body">
    <div class="container-fluid">
        ...
        <!-- row -->
        <div class="row">
            <div class="col-xl-12 col-lg-12" style="margin-left: -20vh; margin-top: -30px;">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            <form action="<?= base_url(); ?>/landing_page/save_pasien_lama" method="POST">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-row align-items-center">
                                            <div class="col">
                                                ...
                                                <select name="status_pembayaran" id="status_pembayaran" class="" id="inlineFormCustomSelect">
