    ...
    <div class="container-fluid">
        ...
        <div class="form-head d-flex mb-3 mb-md-5 align-items-start">
            <div class="mr-auto d-none d-lg-block">
                <h3 class="text-primary font-w600">Daftar Struk</h3>
            </div>
        </div>
                                    ...
                                    <div class="table-responsive ">
                                        ...
                                        <table class="table patient-activity">
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="mb-0">Nomor Struk</p>
                                                    <h5 class="my-0 text-primary"><?= $dp['id_struk']; ?></h5>
                                                </td>
                                                <td>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="dropdown ml-auto">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a class="dropdown-item" href="<?= base_url() ?>/daftar_struk/edit_struk/<?= $dp['id_struk']; ?>">Edit</a>
                                                                <a class="dropdown-item" href="<?= base_url() ?>/daftar_struk/print_invoive/<?= $dp['id_struk']; ?>">Print</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
